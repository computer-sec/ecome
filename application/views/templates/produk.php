	...
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
				...
				<!-- block2 -->
				<div class="block1 hov-img-zoom pos-relative m-b-30">
					<img src="<?php echo base_url('assets/'); ?>images/isi-konten-kunyit-hitam-720x932.png" alt="IMG-BENNER">
			...
			<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
				...
				<!-- block4 -->
				<div class="block1 hov-img-zoom pos-relative m-b-30">
					<img src="<?php echo base_url('assets/'); ?>images/kunyit 720x932.png" alt="IMG-BENNER">
